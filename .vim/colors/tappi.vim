...
hi TabLineSel      ctermfg=16        ctermbg=248       cterm=none      guifg=#000000    guibg=#a8a8a8    gui=NONE      
hi StatusLine      ctermfg=16        ctermbg=248       cterm=none      guifg=#000000    guibg=#a8a8a8    gui=NONE      
...
hi NonText         ctermfg=16        ctermbg=none      cterm=none      guifg=#000000    guibg=NONE       gui=NONE      
...
hi Search          ctermfg=16        ctermbg=63        cterm=none      guifg=#000000    guibg=#5f5fff    gui=NONE      
hi Visual          ctermfg=none      ctermbg=16        cterm=reverse   guifg=NONE       guibg=#000000    gui=reverse   
...
hi DiffChange      ctermbg=24        ctermbg=none      cterm=none     
